...
def drive(cfg, model_path=None, use_joystick=False, model_type=None,
    ...
    if cfg.STOP_SIGN_DETECTOR:
        from donkeycar.parts.object_detector.tiny_yolo import ObjectDetectorTinyYolo
        V.add(ObjectDetectorTinyYolo(), inputs=['cam/image_array'], outputs=['detected_objects'], threaded=True)
        #from donkeycar.parts.object_detector.mobilenet_ssd import ObjectDetectorMobileSSD
        #V.add(ObjectDetectorMobileSSD(), inputs=['cam/image_array'], outputs = ['detected_objects'], threaded = True)
        #from donkeycar.parts.object_detector.efficientnetlite import ObjectDetectorEfficientNetLite
        #V.add(ObjectDetectorEfficientNetLite(), inputs=['cam/image_array'], outputs = ['detected_objects'], threaded = True)
    #
