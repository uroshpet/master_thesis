...
def drive(cfg, model_path=None, use_joystick=False, model_type=None,
    ...
    if cfg.PURE_PURSUIT_CONTROLLER:
        from donkeycar.parts.pure_pursuit.pure_pursuit_only import PurePursuitOnly
        V.add(PurePursuitOnly(cfg.PURE_PURSUIT_LOOKAHEAD_DISTANCE, (cfg.IMAGE_W,cfg.IMAGE_H), cfg.PURE_PURSUIT_HOST), inputs = ['cam/image_array'], outputs = ['pure_steering'], threaded = True)
    #
